...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        ...
        <div class="card p-3">
            ...
            <div style="font-family:var(--font-mono);font-size:13px;font-weight:600;margin-bottom:12px;color:var(--text-primary)">
                <?= htmlspecialchars($botWaNumber) ?>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   disabled style="background:#f8fafc;font-family:var(--font-mono)">
