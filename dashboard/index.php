            ...
            <div class="ik-grid2">
                ...
                <div class="ik-card al">
                    <div class="ik-ch">
                        ...
                        <div><div class="ik-ch-ttl">Rata-rata harian</div><div class="ik-ch-sub">Pengeluaran per hari</div></div>
                    </div>
                    ...
                    <div style="margin-top:10px;border-top:0.5px solid rgba(0,0,0,.07);padding-top:8px">
                        ...
                        <div class="ik-row"><span class="ik-lbl">Bulanan (estimasi)</span><span style="font-size:12px;font-weight:500"><?= formatRp((int)($avgDailyExpense*30)) ?></span></div>
                    </div>
                </div>
            </div>
